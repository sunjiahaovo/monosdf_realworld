...
import os
from training.monosdf_train_uncer import MonoSDFTrainRunner_uncer
import datetime
...
if __name__ == '__main__':
    ...
    parser.add_argument('--conf', type=str, default='./confs/l435_im_grids.conf')
    parser.add_argument('--expname', type=str, default='')
    parser.add_argument("--exps_folder", type=str, default="exps2")
    #parser.add_argument('--gpu', type=str, default='auto', help='GPU to use [default: GPU auto]')
    parser.add_argument('--is_continue', default=False, action="store_true",
                        help='If set, indicates continuing from a previous run.')
    parser.add_argument('--timestamp', default='t265_nodepth', type=str,
                        help='The timestamp of the run to be used in case of continuing from a previous run.')
    parser.add_argument('--checkpoint', default='66920', type=str,
                        help='The checkpoint epoch of the run to be used in case of continuing from a previous run.')
    parser.add_argument('--scan_id', type=int, default=7, help='If set, taken to be the scan id.')
    ...
    print("opt.render_only = ", opt)


    gpu = 0
    print("gpu = ", gpu)
    trainrunner = MonoSDFTrainRunner_uncer(conf=opt.conf,
