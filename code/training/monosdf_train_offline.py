...
class MonoSDFTrainRunner_online():
    def __init__(self,**kwargs):
        ...
        if kwargs['render_only']:
                self.plots_dir = "../exps/l435_rgbd_grids_4/2022_10_28_19_03_39/plots"
        ...
        if kwargs['render_only']:
            ckpt = '../exps/l435_rgbd_grids_4/2022_10_28_19_03_39/checkpoints/ModelParameters/100.pth'
            print(ckpt)
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.nepochs + 1):
            ...
            if self.GPU_INDEX == 0 and self.do_vis and epoch % self.plot_freq == 0:
                ...
                self.render_test(epoch,data_type="train",index = 37)
