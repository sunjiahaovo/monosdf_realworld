...
class MonoSDFTrainRunner_online():
    def __init__(self,**kwargs):
        ...
        if kwargs['render_only']:
                self.plots_dir = "../exps/room_im2_grids_1/2022_11_22_19_15_18/plots"
        ...
        if kwargs['render_only']:
            ckpt = '../exps/room_im2_grids_1/2022_11_22_19_15_18/checkpoints/ModelParameters/30000.pth'
            print(ckpt)
    ...
    def run(self):
        ...
        while(n_index < self.train_dataset.n_images and False):
            ...
            if self.iter_step%50==0 and self.iter_step>0:
                ...
                if self.GPU_INDEX == 0 and self.iter_step%1000==0:
                    self.model.eval()
                    self.render_test(self.iter_step,data_type="train",index = n_index)
                    self.save_checkpoints(self.iter_step)
        ...
        for epoch in range(self.start_epoch, self.nepochs + 1):
            ...
            if self.GPU_INDEX == 0 and self.do_vis and epoch % self.plot_freq == 0 :
                ...
                self.render_test(self.iter_step,data_type="train",index = 60)
                # self.render_test(self.iter_step,data_type="test",index = 188)
            ...
            for data_index, (indices, model_input, ground_truth) in enumerate(self.train_dataloader):
                ...
                for k in range(num):
                    ...
                    if self.BA and index > 0:
                        ...
                        pose_loss = torch.mean((init_camera_tensor.cuda()-camera_tensor) ** 2)*100
